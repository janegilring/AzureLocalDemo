...
@description('Install Entra ID login extension for Linux.')
param enableEntraIdLoginForLinux bool = false
...
resource entraIdLoginForLinux 'Microsoft.HybridCompute/machines/extensions@2024-07-10' = if (enableEntraIdLoginForLinux) {
  parent: hybridComputeMachine
  location: location
  name: 'AADSSHLogin'
  properties: {
