...
param aksControlPlaneNodeSize string = 'Standard_A2_v2'
param aksControlPlaneNodeCount int = 1
param aksControlPlaneIP string = ''
param aksKubernetesVersion string = 'v1.28.9'

// Default to 1 node node pool
param aksNodePoolName string = 'nodepool1'
param aksNodePoolNodeSize string = 'Standard_A2_v2'
...
resource connectedCluster 'Microsoft.Kubernetes/ConnectedClusters@2024-01-01' = {
  ...
  properties: {
    ...
    aadProfile: {
      ...
      adminGroupObjectIDs: ['88122f49-387e-4ce5-9c5f-ffe1c851604a'] // aks-local-admins
    }
  }
}
